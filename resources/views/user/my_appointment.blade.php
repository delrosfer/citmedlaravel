      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="doctors.html">Médicos</a>
            </li>
  ...
  <div align="center" style="padding: 70px;">
    <table class="table table-hover table-bordered table-striped">
      <tr style="background-color: darkblue;" align="center">
        ...
        <th style="padding: 10px; font-size: 20px; color: white;">Comentario</th>
      ...
      <tr class="bg-teal-500" align="center">
        ...
        <td> <a class="btn btn-danger text-center txt-sm up-btn" onclick="return confirm('¿Está seguro de eliminar esta cita? con fecha {{ $appoints->date }}')" href="{{ url('cancel_appoint', $appoints->id) }}">Cancelar</a></td>
      </tr>
      @endforeach
    </table>
  </div>
